...
public interface Settings {
    ...
    public interface Conveyor {
        ...
        SmartNumber SHOOT_WAIT_DELAY = new SmartNumber("Conveyor/Shoot Wait Delay", 2.0 /*0.35*/);
    ...
    public interface Alignment {
        ...
        SmartNumber PODIUM_SHOT_DISTANCE = new SmartNumber("Shooter/Podium Distance", 3.1);
