...
public class SwerveDriveToShootWithoutStopping extends Command {

    public static SwerveDriveToShootWithoutStopping withHigherDebounce() {
        return new SwerveDriveToShootWithoutStopping(Alignment.PODIUM_SHOT_DISTANCE, 0.75);
    }
    ...
    public SwerveDriveToShootWithoutStopping() {
        this(0);
    }

    public SwerveDriveToShootWithoutStopping(double shootTimeout) {
        this(Alignment.PODIUM_SHOT_DISTANCE, shootTimeout);
    }

    public SwerveDriveToShootWithoutStopping(Number targetDistance, double shootTimeout) {
        this(targetDistance, Alignment.DEBOUNCE_TIME, shootTimeout);
    }
    
    public SwerveDriveToShootWithoutStopping(Number targetDistance, double debounce, double shootTimeout) {
        ...
        isAligned = BStream.create(this::isAligned)
            ...
            .filtered(new BDebounce.Falling(Settings.Shooter.SHOOT_TIME_DEBOUNCE));
        
        isFinished = isAligned
            .filtered(new BDebounceRC.Rising(shootTimeout))
            .filtered(x -> shootTimeout == 0 ? false : x);
    ...
    public SwerveDriveToShootWithoutStopping withTolerance(double distanceTolerance, double angleTolerance) {
        this.distanceTolerance = distanceTolerance;
        this.angleTolerance = angleTolerance;
        return this;
    }
    
    public SwerveDriveToShootWithoutStopping withRotationConstants(double p, double i, double d) {
